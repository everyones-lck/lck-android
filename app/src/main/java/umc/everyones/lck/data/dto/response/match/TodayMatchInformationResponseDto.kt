...
data class TodayMatchInformationResponseDto(
    ...
    data class MatchResponsesDto(
        ...
        fun toMatchResponseModel() =
            TodayMatchInformationModel.MatchResponsesModel(matchId, matchDate.replace("T", " ").dropLast(3), team1Name, team1LogoUrl, team2Name, team2LogoUrl, team1VoteRate, team2VoteRate, seasonInfo, matchNumber)
    }
